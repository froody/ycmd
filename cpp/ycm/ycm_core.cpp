...
BOOST_PYTHON_MODULE(ycm_core)
{
  ...
  class_< ClangCompleter, boost::noncopyable >( "ClangCompleter" )
    ...
    .def( "CompletionForLocationInFile",
          &ClangCompleter::CompletionForLocationInFile )
    .def( "CandidatesFromCompletion", &ClangCompleter::CandidatesFromCompletion )
    .def( "NumCandidatesFromCompletion", &ClangCompleter::NumCandidatesFromCompletion )
    .def( "ContextFromCompletion", &ClangCompleter::ContextFromCompletion )
    .def( "ObjcSelectorFromCompletion", &ClangCompleter::ObjcSelectorFromCompletion )
  ...
  enum_<CXCompletionContext>("CompletionContext")
      .value("Unexposed", CXCompletionContext_Unexposed)
      .value("AnyType", CXCompletionContext_AnyType)
      .value("AnyValue", CXCompletionContext_AnyValue)
      .value("ObjCObjectValue", CXCompletionContext_ObjCObjectValue)
      .value("ObjCSelectorValue", CXCompletionContext_ObjCSelectorValue)
      .value("CXXClassTypeValue", CXCompletionContext_CXXClassTypeValue)
      .value("DotMemberAccess", CXCompletionContext_DotMemberAccess)
      .value("ArrowMemberAccess", CXCompletionContext_ArrowMemberAccess)
      .value("ObjCPropertyAccess", CXCompletionContext_ObjCPropertyAccess)
      .value("EnumTag", CXCompletionContext_EnumTag)
      .value("UnionTag", CXCompletionContext_UnionTag)
      .value("StructTag", CXCompletionContext_StructTag)
      .value("ClassTag", CXCompletionContext_ClassTag)
      .value("Namespace", CXCompletionContext_Namespace)
      .value("NestedNameSpecifier", CXCompletionContext_NestedNameSpecifier)
      .value("ObjCInterface", CXCompletionContext_ObjCInterface)
      .value("ObjCProtocol", CXCompletionContext_ObjCProtocol)
      .value("ObjCCategory", CXCompletionContext_ObjCCategory)
      .value("ObjCInstanceMessage", CXCompletionContext_ObjCInstanceMessage)
      .value("ObjCClassMessage", CXCompletionContext_ObjCClassMessage)
      .value("ObjCSelectorName", CXCompletionContext_ObjCSelectorName)
      .value("MacroName", CXCompletionContext_MacroName)
      .value("NaturalLanguage", CXCompletionContext_NaturalLanguage)
      .value("Unknown", CXCompletionContext_Unknown)
      .export_values();

  class_< CXCodeCompleteResults ,
      std::shared_ptr< CXCodeCompleteResults > >( "CodeCompletionResult" );
